...
void informacoes(){
    printf("\nRenda informada: %.2f\nValor do empréstimo solicitado: %.2f\nHistorico de Credito anterior B-Bom , R-Ruim: %c\nEstabilidade no emprego E-Estável, I-Instável: %c\nValor da entrada informada: %.2f\n",
...
void formulario() {
    printf("\t\t**Análise de Empréstimo Financeiro. v2.8**\n");
