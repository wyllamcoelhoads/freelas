...
void informacoes(){
    printf("Renda informada: %.2f\n", rendaMensal);
    printf("Valor do empréstimo solicitado: %.2f\n", valorEmprestimo);
    printf("Valor da entrada informada: %.2f\n", valorEntrada);
    printf("Quantidades de meses para pagar: %d\n", mesesPagar);
    printf("Valor maximo da parcela: %.2f\n", rendaMensal * 0.30);
    printf("Valor real da parcela: %.2f\n", (valorEmprestimo - valorEntrada) / mesesPagar);
...
void formulario() {
    printf("\t\t**Análise de Empréstimo Financeiro. v3.0**\n");
