...
float calculaPorcentagem(float cRendaMensal, float cValorEmprestimo, float cEntrada, int cMesesPagar) {
    float parcelaMensal;
    float limiteParcela;
...
void formulario() {
    printf("\t\t**Análise de Empréstimo Financeiro.**\n");
    ...
    printf("Retorno da função calculaPorcentagem: %.2f\n", total);
}
